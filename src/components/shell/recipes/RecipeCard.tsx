...
const RecipeCard = ({ title, imageUrl, rating, reviewCount, cookTime, difficulty }: RecipeCardProps1) => {
    return (
        <article className="group bg-surface-container-lowest rounded-xl recipe-card-shadow w-55  flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
